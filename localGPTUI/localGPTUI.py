...
def home_page():
    if request.method == "POST":
        if "user_prompt" in request.form:
            ...
            main_prompt_url = "http://45.135.56.211:10631/api/prompt_route"
            ...
            delete_source_url = "http://45.135.56.211:10631/api/delete_source"  # URL of the /api/delete_source endpoint
            if request.form.get("action") == "reset":
                response = requests.get(delete_source_url)

            save_document_url = "http://45.135.56.211:10631/api/save_document"
            run_ingest_url = "http://45.135.56.211:10631/api/run_ingest"  # URL of the /api/run_ingest endpoint
